...
import { teamPerformanceChartData } from "./manager-data"
...
export default function ManagerPerformanceChart({
  ...
  subtitle = "Average progress and monthly completions for your team",
}) {
  return (
      ...
      <div className="mx-6 mb-6 rounded-2xl bg-gradient-to-br from-slate-950 via-slate-900 to-violet-950/50 p-4 ring-1 ring-white/5 sm:p-6">
        <div className="mb-4 flex flex-wrap items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-medium text-slate-400">Avg. Progress</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="h-[220px] w-full sm:h-[280px]">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              <defs>
                <linearGradient id="mgrProgressGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#8b5cf6" stopOpacity={0.45} />
                  <stop offset="100%" stopColor="#8b5cf6" stopOpacity={0} />
                </linearGradient>
                <linearGradient id="mgrCompleteGrad" x1="0" y1="0" x2="0" y2="1">
