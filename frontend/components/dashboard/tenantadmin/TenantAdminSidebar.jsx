...
export function TenantSidebarNav({ className, onNavigate }) {
    ...
    <div className="border-t border-white/10 pt-4">
      <div className="mb-3 flex items-center gap-2 rounded-xl bg-white/5 px-3 py-2">
        ...
        <div className="min-w-0">
          ...
          <p className="truncate text-[10px] text-slate-500">{tenantInfo.plan}</p>
        </div>
      </div>
      <div className="flex items-center justify-between gap-2">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="truncate text-xs text-slate-500">Tenant Admin</p>
          </div>
        </div>
        <button
          type="button"
