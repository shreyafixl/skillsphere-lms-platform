        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <DashboardCard>
              <SectionHeader
                ...
                subtitle="Your super admin account details"
              />
    
              <div className="flex items-center gap-4 border-b border-slate-100 pb-5 dark:border-slate-800">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-fuchsia-600 text-lg font-bold text-white shadow-md">
                  A
                </div>
                ...
                <div>
                  ...
                  <span className="mt-2 inline-flex rounded-lg bg-violet-50 px-2 py-1 text-[11px] font-semibold text-violet-700 dark:bg-violet-500/15 dark:text-violet-300">
                    Super Admin
                  </span>
                </div>
              </div>
                ...
                {themeOptions.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex flex-col items-center gap-2 rounded-2xl border p-3 transition-all duration-300",
                        isActive
                          ? "border-violet-500 bg-violet-50 shadow-sm shadow-violet-500/10 dark:border-violet-500 dark:bg-violet-500/15"
            ...
            <DashboardCard>
              ...
              <div className="mt-3 space-y-0 border-t border-slate-100 pt-3 dark:border-slate-800">
                <SettingsRow
                  icon={Key}
                  ...
                  action={
                    <button
                      type="button"
                      className="rounded-xl border border-slate-200 px-3 py-1.5 text-xs font-medium transition-colors hover:border-violet-200 hover:bg-violet-50 dark:border-slate-700 dark:hover:border-violet-500/40 dark:hover:bg-violet-500/10"
                    >
                      Update
                    </button>
                  }
          ...
          <DashboardCard className="border-rose-200/50 dark:border-rose-900/50">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                type="button"
                className="rounded-xl border border-rose-200 px-4 py-2 text-sm font-semibold text-rose-600 transition-colors hover:bg-rose-50 dark:border-rose-800 dark:text-rose-400 dark:hover:bg-rose-500/10"
              >
