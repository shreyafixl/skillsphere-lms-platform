...
function ChartShell({ title, subtitle, children }) {
  return (
    ...
    >
      ...
      <div className="mx-4 mb-4 rounded-2xl bg-gradient-to-br from-slate-950 via-slate-900 to-violet-950/40 p-4">
      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
          <ChartShell
            ...
            subtitle="Monthly revenue and MRR trends"
          >
        ...
        <ChartShell
          ...
          subtitle="Revenue and user growth correlation"
        >
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart
        ...
        <DashboardCard>
          <SectionHeader
            ...
            subtitle="Key health and engagement metrics"
          />
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {performanceData.map((item) => (
              <div
                key={item.metric}
                className="rounded-2xl border border-slate-100 p-3.5 transition-colors hover:border-violet-200 hover:bg-violet-50/30 dark:border-slate-800 dark:hover:border-violet-500/30 dark:hover:bg-violet-500/5"
              >
                <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                  {item.metric}
                </p>

                <p className="mt-1.5 text-xl font-bold text-slate-900 dark:text-slate-50">
                  {item.metric === "API Latency"
                    ? `${item.value}ms`
                    : `${item.value}%`}
                </p>
