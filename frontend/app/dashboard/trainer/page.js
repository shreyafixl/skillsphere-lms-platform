  ...
  return (
    ...
    >
      <TrainerLayout topbarTitle="Overview">
        ...
        <TrainerPageSection className="space-y-5">
          <PageHeader
            title={trainerCopy.dashboardHeading}
            description={
              trainerCopy.dashboardDescription
            }
            action={
              <PrimaryActionButton
                onClick={() =>
          ...
          <TrainerStaggerGrid className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
            {quickLinks.map((link) => {
